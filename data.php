...
$data[11] = ['question' => '做100减7,然后从所得到的数目再减去7', 
			 'point' => array('100 - 7 = ?', '93 - 7 = ', '86 - 7 = ?', '79 - 7 = ?', '72 - 7 = 65', '65 - 7 = ?')];

$data[12] = ['question' => '现在告诉我刚才我要你记住的三样东西是什么?', 
			 'point' => array('皮球', '国旗', '树木')];	

$data[13] = ['question' => '请问这是什么?', 'point' => array('橡皮'), 'img' => array('/res/eraser.jpg')];	

$data[14] = ['question' => '请问这是什么?', 'point' => array('铅笔'), 'img' => array('/res/pen.jpg')];	
